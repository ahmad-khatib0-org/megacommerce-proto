...
pub struct CustomerProfileRequest {}
#[derive(serde::Serialize, serde::Deserialize)]
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub struct CustomerProfileResponse {
    #[prost(oneof = "customer_profile_response::Response", tags = "1, 2")]
    pub response: ::core::option::Option<customer_profile_response::Response>,
}
/// Nested message and enum types in `CustomerProfileResponse`.
pub mod customer_profile_response {
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive(Clone, PartialEq, ::prost::Oneof)]
    pub enum Response {
        #[prost(message, tag = "1")]
        Data(super::CustomerProfile),
        #[prost(message, tag = "2")]
        Error(super::super::super::shared::v1::AppError),
    }
}
...
pub mod users_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn get_customer_profile(
            &mut self,
            request: impl tonic::IntoRequest<super::CustomerProfileRequest>,
        ) -> std::result::Result<
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/users.v1.UsersService/GetCustomerProfile" => {
                    #[allow(non_camel_case_types)]
                    struct GetCustomerProfileSvc<T: UsersService>(pub Arc<T>);
                    impl<
                        T: UsersService,
                    > tonic::server::UnaryService<super::CustomerProfileRequest>
                    for GetCustomerProfileSvc<T> {
                        type Response = super::CustomerProfileResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as UsersService>::get_customer_profile(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
