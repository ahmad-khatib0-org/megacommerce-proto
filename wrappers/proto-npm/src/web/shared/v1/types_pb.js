...
goog.exportSymbol('proto.shared.v1.SuccessResponseData', null, global);
/**
 ...
 * @constructor
 */
proto.shared.v1.SuccessResponseData = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.shared.v1.SuccessResponseData, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.shared.v1.SuccessResponseData.displayName = 'proto.shared.v1.SuccessResponseData';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.shared.v1.SuccessResponseData.prototype.toObject = function(opt_includeInstance) {
  return proto.shared.v1.SuccessResponseData.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.shared.v1.SuccessResponseData} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.shared.v1.SuccessResponseData.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 */
proto.shared.v1.SuccessResponseData.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.shared.v1.SuccessResponseData;
  return proto.shared.v1.SuccessResponseData.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.shared.v1.SuccessResponseData} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.shared.v1.SuccessResponseData}
 */
proto.shared.v1.SuccessResponseData.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.shared.v1.SuccessResponseData.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.shared.v1.SuccessResponseData.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.shared.v1.SuccessResponseData} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.shared.v1.SuccessResponseData.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {string}
 */
proto.shared.v1.SuccessResponseData.prototype.getMessage = function() {
...
/**
 * @param {string} value
 * @return {!proto.shared.v1.SuccessResponseData} returns this
 */
proto.shared.v1.SuccessResponseData.prototype.setMessage = function(value) {
 ...
 * @return {!proto.shared.v1.SuccessResponseData} returns this
 */
proto.shared.v1.SuccessResponseData.prototype.clearMessage = function() {
 ...
 * @return {boolean}
 */
proto.shared.v1.SuccessResponseData.prototype.hasMessage = function() {
  return jspb.Message.getField(this, 1) != null;
};
 ...
 * @return {!jspb.Map<string,string>}
 */
proto.shared.v1.SuccessResponseData.prototype.getMetadataMap = function(opt_noLazyCreate) {
  return /** @type {!jspb.Map<string,string>} */ (
 ...
 * @return {!proto.shared.v1.SuccessResponseData} returns this
 */
proto.shared.v1.SuccessResponseData.prototype.clearMetadataMap = function() {
