...
export const ConfigOAuth: MessageFns<ConfigOAuth> = {
  encode(message: ConfigOAuth, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.frontendLoginUrl !== undefined) {
      writer.uint32(98).string(message.frontendLoginUrl);
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 12: {
          ...
          message.frontendLoginUrl = reader.string();
          continue;
        }
        case 13: {
          if (tag !== 106) {
  ...
  fromJSON(object: any): ConfigOAuth {
    return {
      ...
      frontendLoginUrl: isSet(object.frontendLoginUrl) ? globalThis.String(object.frontendLoginUrl) : undefined,
  ...
  toJSON(message: ConfigOAuth): unknown {
    ...
    if (message.frontendLoginUrl !== undefined) {
      obj.frontendLoginUrl = message.frontendLoginUrl;
    }
    if (message.frontendLoginErrorUrl !== undefined) {
