...
export function orderEventTypeFromJSON(object: any): OrderEventType {
  switch (object) {
    ...
    case 7:
    case "ORDER_EVENT_ORDER_ITEM_REFUNDED":
      return OrderEventType.ORDER_EVENT_ORDER_ITEM_REFUNDED;
    case 8:
    case "ORDER_EVENT_ORDER_ITEM_REFUND_REQUESTED":
      return OrderEventType.ORDER_EVENT_ORDER_ITEM_REFUND_REQUESTED;
    case 9:
...
export function orderEventTypeToJSON(object: OrderEventType): string {
  switch (object) {
    ...
    case OrderEventType.ORDER_EVENT_ORDER_ITEM_REFUNDED:
      return "ORDER_EVENT_ORDER_ITEM_REFUNDED";
    case OrderEventType.ORDER_EVENT_ORDER_ITEM_REFUND_REQUESTED:
      return "ORDER_EVENT_ORDER_ITEM_REFUND_REQUESTED";
