...
export const ProductsServiceService = {
  productCreate: {
    ...
    requestSerialize: (value: ProductCreateRequest) => Buffer.from(ProductCreateRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => ProductCreateRequest.decode(value),
    responseSerialize: (value: ProductCreateResponse) => Buffer.from(ProductCreateResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => ProductCreateResponse.decode(value),
  },
  productData: {
    path: "/products.v1.ProductsService/ProductData",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: ProductDataRequest) => Buffer.from(ProductDataRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => ProductDataRequest.decode(value),
    responseSerialize: (value: ProductDataResponse) => Buffer.from(ProductDataResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => ProductDataResponse.decode(value),
  },
  productList: {
    path: "/products.v1.ProductsService/ProductList",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: ProductListRequest) => Buffer.from(ProductListRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => ProductListRequest.decode(value),
