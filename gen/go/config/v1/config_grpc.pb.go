...
type ConfigServiceClient interface {
	GetConfig(ctx context.Context, in *GetConfigRequest, opts ...grpc.CallOption) (*v1.Config, error)
}
...
func (c *configServiceClient) GetConfig(ctx context.Context, in *GetConfigRequest, opts ...grpc.CallOption) (*v1.Config, error) {
...
type ConfigServiceServer interface {
	GetConfig(context.Context, *GetConfigRequest) (*v1.Config, error)
...
func (UnimplementedConfigServiceServer) GetConfig(context.Context, *GetConfigRequest) (*v1.Config, error) {
