...
const (
	UserService_CreateSupplier_FullMethodName = "/user.v1.UserService/CreateSupplier"
)
...
func _UserService_CreateSupplier_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(UserServiceServer).CreateSupplier(ctx, in)
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _UserService_CreateSupplier_Handler,
		},
	},
