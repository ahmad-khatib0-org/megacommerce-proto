...
func (x *SupplierCreateRequest) Reset() {
	*x = SupplierCreateRequest{}
	mi := &file_users_v1_supplier_proto_msgTypes[0]
...
func (*SupplierCreateRequest) Descriptor() ([]byte, []int) {
	return file_users_v1_supplier_proto_rawDescGZIP(), []int{0}
}
...
func (x *SupplierCreateResponse) Reset() {
	*x = SupplierCreateResponse{}
	mi := &file_users_v1_supplier_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SupplierCreateResponse) Descriptor() ([]byte, []int) {
	return file_users_v1_supplier_proto_rawDescGZIP(), []int{1}
}
...
var File_users_v1_supplier_proto protoreflect.FileDescriptor
...
const file_users_v1_supplier_proto_rawDesc = "" +
	...
	"\n" +
	"\bresponseBq\n" +
	"\x19org.megacommerce.users.v1B\rSupplierProtoZBgithub.com/ahmad-khatib0-org/megacommerce-proto/gen/go/users/v1;v1\xf8\x01\x01b\x06proto3"

var (
	file_users_v1_supplier_proto_rawDescOnce sync.Once
	file_users_v1_supplier_proto_rawDescData []byte
)

func file_users_v1_supplier_proto_rawDescGZIP() []byte {
	file_users_v1_supplier_proto_rawDescOnce.Do(func() {
		file_users_v1_supplier_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_users_v1_supplier_proto_rawDesc), len(file_users_v1_supplier_proto_rawDesc)))
	})
	return file_users_v1_supplier_proto_rawDescData
}

var file_users_v1_supplier_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
...
func file_users_v1_supplier_proto_init() {
	if File_users_v1_supplier_proto != nil {
		return
	}
	file_users_v1_supplier_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_users_v1_supplier_proto_rawDesc), len(file_users_v1_supplier_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_users_v1_supplier_proto_goTypes,
		DependencyIndexes: file_users_v1_supplier_proto_depIdxs,
		MessageInfos:      file_users_v1_supplier_proto_msgTypes,
	}.Build()
	File_users_v1_supplier_proto = out.File
	file_users_v1_supplier_proto_goTypes = nil
	file_users_v1_supplier_proto_depIdxs = nil
}
