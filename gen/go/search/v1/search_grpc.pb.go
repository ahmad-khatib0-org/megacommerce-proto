...
const (
	SearchService_Ping_FullMethodName = "/search.v1.SearchService/Ping"
)
...
func (c *searchServiceClient) Ping(ctx context.Context, in *v1.PingRequest, opts ...grpc.CallOption) (*v1.PingResponse, error) {
...
func (UnimplementedSearchServiceServer) Ping(context.Context, *v1.PingRequest) (*v1.PingResponse, error) {
...
func _SearchService_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SearchServiceServer).Ping(ctx, req.(*v1.PingRequest))
	}
