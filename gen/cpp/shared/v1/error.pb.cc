...
const uint32_t TableStruct_shared_2fv1_2ferror_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::shared::v1::AppError, id_),
  PROTOBUF_FIELD_OFFSET(::shared::v1::AppError, message_),
  PROTOBUF_FIELD_OFFSET(::shared::v1::AppError, detailed_error_),
  PROTOBUF_FIELD_OFFSET(::shared::v1::AppError, request_id_),
  PROTOBUF_FIELD_OFFSET(::shared::v1::AppError, status_code_),
  PROTOBUF_FIELD_OFFSET(::shared::v1::AppError, where_),
  PROTOBUF_FIELD_OFFSET(::shared::v1::AppError, skip_translation_),
  PROTOBUF_FIELD_OFFSET(::shared::v1::AppError, params_),
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_shared_2fv1_2ferror_2eproto = {
  false, false, 452, descriptor_table_protodef_shared_2fv1_2ferror_2eproto, "shared/v1/error.proto", 
...
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_shared_2fv1_2ferror_2eproto_getter() {
  return &descriptor_table_shared_2fv1_2ferror_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_shared_2fv1_2ferror_2eproto(&descriptor_table_shared_2fv1_2ferror_2eproto);
namespace shared {
namespace v1 {
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "shared.v1.AppError.id"));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "shared.v1.AppError.message"));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 26)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "shared.v1.AppError.detailed_error"));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 34)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "shared.v1.AppError.request_id"));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 6:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 50)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "shared.v1.AppError.where"));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* AppError::_InternalSerialize(
  ...
  if (!this->_internal_detailed_error().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "shared.v1.AppError.detailed_error");
    target = stream->WriteStringMaybeAliased(
