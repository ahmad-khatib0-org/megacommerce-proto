...
static constexpr const ::_pb::EnumDescriptor *PROTOBUF_NONNULL *PROTOBUF_NULLABLE
    file_level_enum_descriptors_shared_2fv1_2ftime_2eproto = nullptr;
static constexpr const ::_pb::ServiceDescriptor *PROTOBUF_NONNULL *PROTOBUF_NULLABLE
    file_level_service_descriptors_shared_2fv1_2ftime_2eproto = nullptr;
const ::uint32_t
    TableStruct_shared_2fv1_2ftime_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        protodesc_cold) = {
        0x081, // bitmap
        PROTOBUF_FIELD_OFFSET(::shared::v1::Timestamp, _impl_._has_bits_),
        5, // hasbit index offset
        PROTOBUF_FIELD_OFFSET(::shared::v1::Timestamp, _impl_.seconds_),
        PROTOBUF_FIELD_OFFSET(::shared::v1::Timestamp, _impl_.nanos_),
        0,
        1,
};
...
static const ::_pbi::MigrationSchema
    schemas[] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
        {0, sizeof(::shared::v1::Timestamp)},
};
static const ::_pb::Message* PROTOBUF_NONNULL const file_default_instances[] = {
    &::shared::v1::_Timestamp_default_instance_._instance,
};
const char descriptor_table_protodef_shared_2fv1_2ftime_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    protodesc_cold) = {
...
static ::absl::once_flag descriptor_table_shared_2fv1_2ftime_2eproto_once;
PROTOBUF_CONSTINIT const ::_pbi::DescriptorTable descriptor_table_shared_2fv1_2ftime_2eproto = {
    false,
    false,
    215,
    descriptor_table_protodef_shared_2fv1_2ftime_2eproto,
    "shared/v1/time.proto",
    &descriptor_table_shared_2fv1_2ftime_2eproto_once,
    nullptr,
    0,
    1,
    schemas,
    file_default_instances,
    TableStruct_shared_2fv1_2ftime_2eproto::offsets,
    file_level_enum_descriptors_shared_2fv1_2ftime_2eproto,
    file_level_service_descriptors_shared_2fv1_2ftime_2eproto,
};
namespace shared {
namespace v1 {
// ===================================================================
...
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:shared.v1.Timestamp)
}
Timestamp::Timestamp(
...
Timestamp::~Timestamp() {
  // @@protoc_insertion_point(destructor:shared.v1.Timestamp)
  SharedDtor(*this);
}
...
Timestamp::_table_ = {
  {
    ...
    ::_pbi::TcParser::GetTable<::shared::v1::Timestamp>(),  // to_prefetch
...
// @@protoc_insertion_point(message_clear_start:shared.v1.Timestamp)
...
::uint8_t* PROTOBUF_NONNULL Timestamp::_InternalSerialize(
...
#endif  // PROTOBUF_CUSTOM_VTABLE
  // @@protoc_insertion_point(serialize_to_array_start:shared.v1.Timestamp)
  ::uint32_t cached_has_bits = 0;
  (void)cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:shared.v1.Timestamp)
  return target;
}
...
::size_t Timestamp::ByteSizeLong() const {
  const Timestamp& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
  // @@protoc_insertion_point(message_byte_size_start:shared.v1.Timestamp)
  ::size_t total_size = 0;
...
void Timestamp::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:shared.v1.Timestamp)
...
// @@protoc_insertion_point(class_specific_copy_from_start:shared.v1.Timestamp)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::std::false_type
    _static_init2_ [[maybe_unused]] =
        (::_pbi::AddDescriptors(&descriptor_table_shared_2fv1_2ftime_2eproto),
         ::std::false_type{});
