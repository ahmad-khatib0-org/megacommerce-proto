...
static constexpr const ::_pb::EnumDescriptor *PROTOBUF_NONNULL *PROTOBUF_NULLABLE
    file_level_enum_descriptors_shared_2fv1_2fwrappers_2eproto = nullptr;
static constexpr const ::_pb::ServiceDescriptor *PROTOBUF_NONNULL *PROTOBUF_NULLABLE
    file_level_service_descriptors_shared_2fv1_2fwrappers_2eproto = nullptr;
const ::uint32_t
    TableStruct_shared_2fv1_2fwrappers_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        protodesc_cold) = {
        0x081, // bitmap
        PROTOBUF_FIELD_OFFSET(::shared::v1::DoubleValue, _impl_._has_bits_),
        4, // hasbit index offset
        PROTOBUF_FIELD_OFFSET(::shared::v1::DoubleValue, _impl_.value_),
        0,
        0x081, // bitmap
        PROTOBUF_FIELD_OFFSET(::shared::v1::FloatValue, _impl_._has_bits_),
        4, // hasbit index offset
        PROTOBUF_FIELD_OFFSET(::shared::v1::FloatValue, _impl_.value_),
        0,
        0x081, // bitmap
        PROTOBUF_FIELD_OFFSET(::shared::v1::Int64Value, _impl_._has_bits_),
        4, // hasbit index offset
        PROTOBUF_FIELD_OFFSET(::shared::v1::Int64Value, _impl_.value_),
        0,
        0x081, // bitmap
        PROTOBUF_FIELD_OFFSET(::shared::v1::UInt64Value, _impl_._has_bits_),
        4, // hasbit index offset
        PROTOBUF_FIELD_OFFSET(::shared::v1::UInt64Value, _impl_.value_),
        0,
        0x081, // bitmap
        PROTOBUF_FIELD_OFFSET(::shared::v1::Int32Value, _impl_._has_bits_),
        4, // hasbit index offset
        PROTOBUF_FIELD_OFFSET(::shared::v1::Int32Value, _impl_.value_),
        0,
        0x081, // bitmap
        PROTOBUF_FIELD_OFFSET(::shared::v1::UInt32Value, _impl_._has_bits_),
        4, // hasbit index offset
        PROTOBUF_FIELD_OFFSET(::shared::v1::UInt32Value, _impl_.value_),
        0,
        0x081, // bitmap
        PROTOBUF_FIELD_OFFSET(::shared::v1::BoolValue, _impl_._has_bits_),
        4, // hasbit index offset
        PROTOBUF_FIELD_OFFSET(::shared::v1::BoolValue, _impl_.value_),
        0,
        0x081, // bitmap
        PROTOBUF_FIELD_OFFSET(::shared::v1::StringValue, _impl_._has_bits_),
        4, // hasbit index offset
        PROTOBUF_FIELD_OFFSET(::shared::v1::StringValue, _impl_.value_),
        0,
        0x081, // bitmap
        PROTOBUF_FIELD_OFFSET(::shared::v1::BytesValue, _impl_._has_bits_),
        4, // hasbit index offset
        PROTOBUF_FIELD_OFFSET(::shared::v1::BytesValue, _impl_.value_),
        0,
};

static const ::_pbi::MigrationSchema
    schemas[] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
        {0, sizeof(::shared::v1::DoubleValue)},
        {5, sizeof(::shared::v1::FloatValue)},
        {10, sizeof(::shared::v1::Int64Value)},
        {15, sizeof(::shared::v1::UInt64Value)},
        {20, sizeof(::shared::v1::Int32Value)},
        {25, sizeof(::shared::v1::UInt32Value)},
        {30, sizeof(::shared::v1::BoolValue)},
        {35, sizeof(::shared::v1::StringValue)},
        {40, sizeof(::shared::v1::BytesValue)},
};
static const ::_pb::Message* PROTOBUF_NONNULL const file_default_instances[] = {
    &::shared::v1::_DoubleValue_default_instance_._instance,
    &::shared::v1::_FloatValue_default_instance_._instance,
    &::shared::v1::_Int64Value_default_instance_._instance,
    &::shared::v1::_UInt64Value_default_instance_._instance,
    &::shared::v1::_Int32Value_default_instance_._instance,
    &::shared::v1::_UInt32Value_default_instance_._instance,
    &::shared::v1::_BoolValue_default_instance_._instance,
    &::shared::v1::_StringValue_default_instance_._instance,
    &::shared::v1::_BytesValue_default_instance_._instance,
};
const char descriptor_table_protodef_shared_2fv1_2fwrappers_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    protodesc_cold) = {
...
static ::absl::once_flag descriptor_table_shared_2fv1_2fwrappers_2eproto_once;
PROTOBUF_CONSTINIT const ::_pbi::DescriptorTable descriptor_table_shared_2fv1_2fwrappers_2eproto = {
    false,
    false,
    489,
    descriptor_table_protodef_shared_2fv1_2fwrappers_2eproto,
    "shared/v1/wrappers.proto",
    &descriptor_table_shared_2fv1_2fwrappers_2eproto_once,
    nullptr,
    0,
    9,
    schemas,
    file_default_instances,
    TableStruct_shared_2fv1_2fwrappers_2eproto::offsets,
    file_level_enum_descriptors_shared_2fv1_2fwrappers_2eproto,
    file_level_service_descriptors_shared_2fv1_2fwrappers_2eproto,
};
namespace shared {
namespace v1 {
// ===================================================================
...
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:shared.v1.DoubleValue)
}
...
DoubleValue::~DoubleValue() {
  // @@protoc_insertion_point(destructor:shared.v1.DoubleValue)
  SharedDtor(*this);
}
...
DoubleValue::_table_ = {
  {
    ...
    ::_pbi::TcParser::GetTable<::shared::v1::DoubleValue>(),  // to_prefetch
...
// @@protoc_insertion_point(message_clear_start:shared.v1.DoubleValue)
...
::uint8_t* PROTOBUF_NONNULL DoubleValue::_InternalSerialize(
...
#endif  // PROTOBUF_CUSTOM_VTABLE
  // @@protoc_insertion_point(serialize_to_array_start:shared.v1.DoubleValue)
  ::uint32_t cached_has_bits = 0;
  (void)cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:shared.v1.DoubleValue)
  return target;
}
...
::size_t DoubleValue::ByteSizeLong() const {
  const DoubleValue& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
  // @@protoc_insertion_point(message_byte_size_start:shared.v1.DoubleValue)
  ::size_t total_size = 0;
...
void DoubleValue::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:shared.v1.DoubleValue)
...
// @@protoc_insertion_point(class_specific_copy_from_start:shared.v1.DoubleValue)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:shared.v1.FloatValue)
}
...
FloatValue::~FloatValue() {
  // @@protoc_insertion_point(destructor:shared.v1.FloatValue)
  SharedDtor(*this);
}
...
FloatValue::_table_ = {
  {
    ...
    ::_pbi::TcParser::GenericFallback,  // fallback
    #ifdef PROTOBUF_PREFETCH_PARSE_TABLE
    ::_pbi::TcParser::GetTable<::shared::v1::FloatValue>(),  // to_prefetch
    #endif  // PROTOBUF_PREFETCH_PARSE_TABLE
  }, {{
...
// @@protoc_insertion_point(message_clear_start:shared.v1.FloatValue)
  ::google::protobuf::internal::TSanWrite(&_impl_);
  ::uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
::uint8_t* PROTOBUF_NONNULL FloatValue::_InternalSerialize(
...
#endif  // PROTOBUF_CUSTOM_VTABLE
  // @@protoc_insertion_point(serialize_to_array_start:shared.v1.FloatValue)
  ::uint32_t cached_has_bits = 0;
  (void)cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:shared.v1.FloatValue)
  return target;
}
...
::size_t FloatValue::ByteSizeLong() const {
  const FloatValue& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
  // @@protoc_insertion_point(message_byte_size_start:shared.v1.FloatValue)
  ::size_t total_size = 0;
...
void FloatValue::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:shared.v1.FloatValue)
  ABSL_DCHECK_NE(&from, _this);
  ::uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_copy_from_start:shared.v1.FloatValue)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:shared.v1.Int64Value)
}
...
Int64Value::~Int64Value() {
  // @@protoc_insertion_point(destructor:shared.v1.Int64Value)
  SharedDtor(*this);
}
...
Int64Value::_table_ = {
  {
    ...
    ::_pbi::TcParser::GenericFallback,  // fallback
    #ifdef PROTOBUF_PREFETCH_PARSE_TABLE
    ::_pbi::TcParser::GetTable<::shared::v1::Int64Value>(),  // to_prefetch
    #endif  // PROTOBUF_PREFETCH_PARSE_TABLE
  }, {{
...
// @@protoc_insertion_point(message_clear_start:shared.v1.Int64Value)
  ::google::protobuf::internal::TSanWrite(&_impl_);
  ::uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
::uint8_t* PROTOBUF_NONNULL Int64Value::_InternalSerialize(
...
#endif  // PROTOBUF_CUSTOM_VTABLE
  // @@protoc_insertion_point(serialize_to_array_start:shared.v1.Int64Value)
  ::uint32_t cached_has_bits = 0;
  (void)cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:shared.v1.Int64Value)
  return target;
}
...
::size_t Int64Value::ByteSizeLong() const {
  const Int64Value& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
  // @@protoc_insertion_point(message_byte_size_start:shared.v1.Int64Value)
  ::size_t total_size = 0;
...
void Int64Value::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:shared.v1.Int64Value)
  ABSL_DCHECK_NE(&from, _this);
  ::uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_copy_from_start:shared.v1.Int64Value)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:shared.v1.UInt64Value)
}
...
UInt64Value::~UInt64Value() {
  // @@protoc_insertion_point(destructor:shared.v1.UInt64Value)
  SharedDtor(*this);
}
...
UInt64Value::_table_ = {
  {
    ...
    ::_pbi::TcParser::GenericFallback,  // fallback
    #ifdef PROTOBUF_PREFETCH_PARSE_TABLE
    ::_pbi::TcParser::GetTable<::shared::v1::UInt64Value>(),  // to_prefetch
    #endif  // PROTOBUF_PREFETCH_PARSE_TABLE
  }, {{
...
// @@protoc_insertion_point(message_clear_start:shared.v1.UInt64Value)
  ::google::protobuf::internal::TSanWrite(&_impl_);
  ::uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
::uint8_t* PROTOBUF_NONNULL UInt64Value::_InternalSerialize(
...
#endif  // PROTOBUF_CUSTOM_VTABLE
  // @@protoc_insertion_point(serialize_to_array_start:shared.v1.UInt64Value)
  ::uint32_t cached_has_bits = 0;
  (void)cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:shared.v1.UInt64Value)
  return target;
}
...
::size_t UInt64Value::ByteSizeLong() const {
  const UInt64Value& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
  // @@protoc_insertion_point(message_byte_size_start:shared.v1.UInt64Value)
  ::size_t total_size = 0;
...
void UInt64Value::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:shared.v1.UInt64Value)
  ABSL_DCHECK_NE(&from, _this);
  ::uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_copy_from_start:shared.v1.UInt64Value)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:shared.v1.Int32Value)
}
...
Int32Value::~Int32Value() {
  // @@protoc_insertion_point(destructor:shared.v1.Int32Value)
  SharedDtor(*this);
}
...
Int32Value::_table_ = {
  {
    ...
    ::_pbi::TcParser::GenericFallback,  // fallback
    #ifdef PROTOBUF_PREFETCH_PARSE_TABLE
    ::_pbi::TcParser::GetTable<::shared::v1::Int32Value>(),  // to_prefetch
    #endif  // PROTOBUF_PREFETCH_PARSE_TABLE
  }, {{
...
// @@protoc_insertion_point(message_clear_start:shared.v1.Int32Value)
  ::google::protobuf::internal::TSanWrite(&_impl_);
  ::uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
::uint8_t* PROTOBUF_NONNULL Int32Value::_InternalSerialize(
...
#endif  // PROTOBUF_CUSTOM_VTABLE
  // @@protoc_insertion_point(serialize_to_array_start:shared.v1.Int32Value)
  ::uint32_t cached_has_bits = 0;
  (void)cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:shared.v1.Int32Value)
  return target;
}
...
::size_t Int32Value::ByteSizeLong() const {
  const Int32Value& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
  // @@protoc_insertion_point(message_byte_size_start:shared.v1.Int32Value)
  ::size_t total_size = 0;
...
void Int32Value::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:shared.v1.Int32Value)
  ABSL_DCHECK_NE(&from, _this);
  ::uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_copy_from_start:shared.v1.Int32Value)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:shared.v1.UInt32Value)
}
...
UInt32Value::~UInt32Value() {
  // @@protoc_insertion_point(destructor:shared.v1.UInt32Value)
  SharedDtor(*this);
}
...
UInt32Value::_table_ = {
  {
    ...
    ::_pbi::TcParser::GenericFallback,  // fallback
    #ifdef PROTOBUF_PREFETCH_PARSE_TABLE
    ::_pbi::TcParser::GetTable<::shared::v1::UInt32Value>(),  // to_prefetch
    #endif  // PROTOBUF_PREFETCH_PARSE_TABLE
  }, {{
...
// @@protoc_insertion_point(message_clear_start:shared.v1.UInt32Value)
  ::google::protobuf::internal::TSanWrite(&_impl_);
  ::uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
::uint8_t* PROTOBUF_NONNULL UInt32Value::_InternalSerialize(
...
#endif  // PROTOBUF_CUSTOM_VTABLE
  // @@protoc_insertion_point(serialize_to_array_start:shared.v1.UInt32Value)
  ::uint32_t cached_has_bits = 0;
  (void)cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:shared.v1.UInt32Value)
  return target;
}
...
::size_t UInt32Value::ByteSizeLong() const {
  const UInt32Value& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
  // @@protoc_insertion_point(message_byte_size_start:shared.v1.UInt32Value)
  ::size_t total_size = 0;
...
void UInt32Value::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:shared.v1.UInt32Value)
  ABSL_DCHECK_NE(&from, _this);
  ::uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_copy_from_start:shared.v1.UInt32Value)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:shared.v1.BoolValue)
}
BoolValue::BoolValue(
...
BoolValue::~BoolValue() {
  // @@protoc_insertion_point(destructor:shared.v1.BoolValue)
  SharedDtor(*this);
}
...
BoolValue::_table_ = {
  {
    ...
    ::_pbi::TcParser::GenericFallback,  // fallback
    #ifdef PROTOBUF_PREFETCH_PARSE_TABLE
    ::_pbi::TcParser::GetTable<::shared::v1::BoolValue>(),  // to_prefetch
    #endif  // PROTOBUF_PREFETCH_PARSE_TABLE
  }, {{
...
// @@protoc_insertion_point(message_clear_start:shared.v1.BoolValue)
  ::google::protobuf::internal::TSanWrite(&_impl_);
  ::uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
::uint8_t* PROTOBUF_NONNULL BoolValue::_InternalSerialize(
...
#endif  // PROTOBUF_CUSTOM_VTABLE
  // @@protoc_insertion_point(serialize_to_array_start:shared.v1.BoolValue)
  ::uint32_t cached_has_bits = 0;
  (void)cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:shared.v1.BoolValue)
  return target;
}
...
::size_t BoolValue::ByteSizeLong() const {
  const BoolValue& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
  // @@protoc_insertion_point(message_byte_size_start:shared.v1.BoolValue)
  ::size_t total_size = 0;
...
void BoolValue::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:shared.v1.BoolValue)
  ABSL_DCHECK_NE(&from, _this);
  ::uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_copy_from_start:shared.v1.BoolValue)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:shared.v1.StringValue)
}
PROTOBUF_NDEBUG_INLINE StringValue::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility,
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const Impl_& from,
    const ::shared::v1::StringValue& from_msg)
...
StringValue::StringValue(
  ...
  // @@protoc_insertion_point(copy_constructor:shared.v1.StringValue)
}
PROTOBUF_NDEBUG_INLINE StringValue::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility,
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena)
...
StringValue::~StringValue() {
  // @@protoc_insertion_point(destructor:shared.v1.StringValue)
  SharedDtor(*this);
}
...
StringValue::_table_ = {
  {
    ...
    ::_pbi::TcParser::GenericFallback,  // fallback
    #ifdef PROTOBUF_PREFETCH_PARSE_TABLE
    ::_pbi::TcParser::GetTable<::shared::v1::StringValue>(),  // to_prefetch
    #endif  // PROTOBUF_PREFETCH_PARSE_TABLE
  }, {{
  ...
  {{
    "\25\5\0\0\0\0\0\0"
    "shared.v1.StringValue"
    "value"
  }},
};
PROTOBUF_NOINLINE void StringValue::Clear() {
// @@protoc_insertion_point(message_clear_start:shared.v1.StringValue)
  ::google::protobuf::internal::TSanWrite(&_impl_);
  ::uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
::uint8_t* PROTOBUF_NONNULL StringValue::_InternalSerialize(
...
#endif  // PROTOBUF_CUSTOM_VTABLE
  // @@protoc_insertion_point(serialize_to_array_start:shared.v1.StringValue)
  ::uint32_t cached_has_bits = 0;
  (void)cached_has_bits;
  ...
  if ((this_._impl_._has_bits_[0] & 0x00000001u) != 0) {
    if (!this_._internal_value().empty()) {
      ...
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "shared.v1.StringValue.value");
  ...
  // @@protoc_insertion_point(serialize_to_array_end:shared.v1.StringValue)
  return target;
}
...
::size_t StringValue::ByteSizeLong() const {
  const StringValue& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
  // @@protoc_insertion_point(message_byte_size_start:shared.v1.StringValue)
  ::size_t total_size = 0;
...
void StringValue::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:shared.v1.StringValue)
  ABSL_DCHECK_NE(&from, _this);
  ::uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_copy_from_start:shared.v1.StringValue)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:shared.v1.BytesValue)
}
PROTOBUF_NDEBUG_INLINE BytesValue::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility,
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const Impl_& from,
    const ::shared::v1::BytesValue& from_msg)
      : _has_bits_{from._has_bits_},
        _cached_size_{0},
        value_(arena, from.value_) {}
...
BytesValue::BytesValue(
  ...
  // @@protoc_insertion_point(copy_constructor:shared.v1.BytesValue)
}
PROTOBUF_NDEBUG_INLINE BytesValue::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility,
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena)
...
BytesValue::~BytesValue() {
  // @@protoc_insertion_point(destructor:shared.v1.BytesValue)
  SharedDtor(*this);
}
...
BytesValue::_table_ = {
  {
    ...
    ::_pbi::TcParser::GenericFallback,  // fallback
    #ifdef PROTOBUF_PREFETCH_PARSE_TABLE
    ::_pbi::TcParser::GetTable<::shared::v1::BytesValue>(),  // to_prefetch
    #endif  // PROTOBUF_PREFETCH_PARSE_TABLE
  }, {{
...
// @@protoc_insertion_point(message_clear_start:shared.v1.BytesValue)
  ::google::protobuf::internal::TSanWrite(&_impl_);
  ::uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
::uint8_t* PROTOBUF_NONNULL BytesValue::_InternalSerialize(
...
#endif  // PROTOBUF_CUSTOM_VTABLE
  // @@protoc_insertion_point(serialize_to_array_start:shared.v1.BytesValue)
  ::uint32_t cached_has_bits = 0;
  (void)cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:shared.v1.BytesValue)
  return target;
}
...
::size_t BytesValue::ByteSizeLong() const {
  const BytesValue& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
  // @@protoc_insertion_point(message_byte_size_start:shared.v1.BytesValue)
  ::size_t total_size = 0;
...
void BytesValue::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:shared.v1.BytesValue)
  ABSL_DCHECK_NE(&from, _this);
  ::uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_copy_from_start:shared.v1.BytesValue)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::std::false_type
    _static_init2_ [[maybe_unused]] =
        (::_pbi::AddDescriptors(&descriptor_table_shared_2fv1_2fwrappers_2eproto),
         ::std::false_type{});
