...
static const ::_pb::EnumDescriptor* PROTOBUF_NONNULL
    file_level_enum_descriptors_shared_2fv1_2fstruct_2eproto[1];
static constexpr const ::_pb::ServiceDescriptor *PROTOBUF_NONNULL *PROTOBUF_NULLABLE
    file_level_service_descriptors_shared_2fv1_2fstruct_2eproto = nullptr;
const ::uint32_t
    TableStruct_shared_2fv1_2fstruct_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        protodesc_cold) = {
        0x081, // bitmap
        PROTOBUF_FIELD_OFFSET(::shared::v1::Struct_FieldsEntry_DoNotUse, _impl_._has_bits_),
        5, // hasbit index offset
        PROTOBUF_FIELD_OFFSET(::shared::v1::Struct_FieldsEntry_DoNotUse, _impl_.key_),
        PROTOBUF_FIELD_OFFSET(::shared::v1::Struct_FieldsEntry_DoNotUse, _impl_.value_),
        0,
        1,
        0x000, // bitmap
        PROTOBUF_FIELD_OFFSET(::shared::v1::Struct, _impl_.fields_),
        0x004, // bitmap
        PROTOBUF_FIELD_OFFSET(::shared::v1::Value, _impl_._oneof_case_[0]),
        ...
        ::_pbi::kInvalidFieldOffsetTag,
        ::_pbi::kInvalidFieldOffsetTag,
        PROTOBUF_FIELD_OFFSET(::shared::v1::Value, _impl_.kind_),
        0x000, // bitmap
        PROTOBUF_FIELD_OFFSET(::shared::v1::ListValue, _impl_.values_),
};

static const ::_pbi::MigrationSchema
    schemas[] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
        {0, sizeof(::shared::v1::Struct_FieldsEntry_DoNotUse)},
        {7, sizeof(::shared::v1::Struct)},
        {9, sizeof(::shared::v1::Value)},
        {18, sizeof(::shared::v1::ListValue)},
};
static const ::_pb::Message* PROTOBUF_NONNULL const file_default_instances[] = {
    &::shared::v1::_Struct_FieldsEntry_DoNotUse_default_instance_._instance,
    &::shared::v1::_Struct_default_instance_._instance,
    &::shared::v1::_Value_default_instance_._instance,
    &::shared::v1::_ListValue_default_instance_._instance,
};
const char descriptor_table_protodef_shared_2fv1_2fstruct_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    protodesc_cold) = {
...
static ::absl::once_flag descriptor_table_shared_2fv1_2fstruct_2eproto_once;
PROTOBUF_CONSTINIT const ::_pbi::DescriptorTable descriptor_table_shared_2fv1_2fstruct_2eproto = {
    false,
    false,
    676,
    descriptor_table_protodef_shared_2fv1_2fstruct_2eproto,
    "shared/v1/struct.proto",
    &descriptor_table_shared_2fv1_2fstruct_2eproto_once,
    nullptr,
    0,
    4,
    schemas,
    file_default_instances,
    TableStruct_shared_2fv1_2fstruct_2eproto::offsets,
    file_level_enum_descriptors_shared_2fv1_2fstruct_2eproto,
    file_level_service_descriptors_shared_2fv1_2fstruct_2eproto,
};
namespace shared {
namespace v1 {
const ::google::protobuf::EnumDescriptor* PROTOBUF_NONNULL NullValue_descriptor() {
  ::google::protobuf::internal::AssignDescriptors(&descriptor_table_shared_2fv1_2fstruct_2eproto);
  return file_level_enum_descriptors_shared_2fv1_2fstruct_2eproto[0];
}
...
Struct_FieldsEntry_DoNotUse::_table_ = {
  {
    ...
    ::_pbi::TcParser::GetTable<::shared::v1::Struct_FieldsEntry_DoNotUse>(),  // to_prefetch
...
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:shared.v1.Struct)
}
PROTOBUF_NDEBUG_INLINE Struct::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility,
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const Impl_& from,
    const ::shared::v1::Struct& from_msg)
...
Struct::Struct(
  ...
  // @@protoc_insertion_point(copy_constructor:shared.v1.Struct)
}
PROTOBUF_NDEBUG_INLINE Struct::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility,
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena)
...
Struct::~Struct() {
  // @@protoc_insertion_point(destructor:shared.v1.Struct)
  SharedDtor(*this);
}
...
Struct::_table_ = {
  {
    ...
    #ifdef PROTOBUF_PREFETCH_PARSE_TABLE
    ::_pbi::TcParser::GetTable<::shared::v1::Struct>(),  // to_prefetch
    #endif  // PROTOBUF_PREFETCH_PARSE_TABLE
  }, {{
...
// @@protoc_insertion_point(message_clear_start:shared.v1.Struct)
...
::uint8_t* PROTOBUF_NONNULL Struct::_InternalSerialize(
...
#endif  // PROTOBUF_CUSTOM_VTABLE
  // @@protoc_insertion_point(serialize_to_array_start:shared.v1.Struct)
  ::uint32_t cached_has_bits = 0;
  (void)cached_has_bits;
 ...
 ::google::protobuf::internal::WireFormatLite::SERIALIZE, "shared.v1.Struct.fields");
      }
    } else {
 ...
 ::google::protobuf::internal::WireFormatLite::SERIALIZE, "shared.v1.Struct.fields");
  ...
  // @@protoc_insertion_point(serialize_to_array_end:shared.v1.Struct)
  return target;
}
...
::size_t Struct::ByteSizeLong() const {
  const Struct& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
  // @@protoc_insertion_point(message_byte_size_start:shared.v1.Struct)
  ::size_t total_size = 0;
...
void Struct::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:shared.v1.Struct)
...
// @@protoc_insertion_point(class_specific_copy_from_start:shared.v1.Struct)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
class Value::_Internal {
 public:
  static constexpr ::int32_t kOneofCaseOffset =
      PROTOBUF_FIELD_OFFSET(::shared::v1::Value, _impl_._oneof_case_);
};

void Value::set_allocated_struct_value(::shared::v1::Struct* PROTOBUF_NULLABLE struct_value) {
  ...
  // @@protoc_insertion_point(field_set_allocated:shared.v1.Value.struct_value)
}
void Value::set_allocated_list_value(::shared::v1::ListValue* PROTOBUF_NULLABLE list_value) {
  ::google::protobuf::Arena* message_arena = GetArena();
  clear_kind();
  if (list_value) {
  ...
  // @@protoc_insertion_point(field_set_allocated:shared.v1.Value.list_value)
}
...
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:shared.v1.Value)
}
PROTOBUF_NDEBUG_INLINE Value::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility,
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const Impl_& from,
    const ::shared::v1::Value& from_msg)
      : kind_{},
        _cached_size_{0},
...
Value::Value(
  ...
  // @@protoc_insertion_point(copy_constructor:shared.v1.Value)
}
PROTOBUF_NDEBUG_INLINE Value::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility,
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena)
...
Value::~Value() {
  // @@protoc_insertion_point(destructor:shared.v1.Value)
  SharedDtor(*this);
}
...
// @@protoc_insertion_point(one_of_clear_start:shared.v1.Value)
  ::google::protobuf::internal::TSanWrite(&_impl_);
  switch (kind_case()) {
    case kNullValue: {
      // No need to clear
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::_pbi::TcParseTable<0, 6, 2, 36, 2>
Value::_table_ = {
  {
    0,  // no _has_bits_
    0, // no _extensions_
    ...
    ::_pbi::TcParser::GenericFallback,  // fallback
    #ifdef PROTOBUF_PREFETCH_PARSE_TABLE
    ::_pbi::TcParser::GetTable<::shared::v1::Value>(),  // to_prefetch
    #endif  // PROTOBUF_PREFETCH_PARSE_TABLE
  }, {{
    {::_pbi::TcParser::MiniParse, {}},
  }}, {{
  ...
  {{
      ...
      {::_pbi::TcParser::GetTable<::shared::v1::ListValue>()},
  }},
  {{
    "\17\0\0\14\0\0\0\0"
    "shared.v1.Value"
...
// @@protoc_insertion_point(message_clear_start:shared.v1.Value)
  ::google::protobuf::internal::TSanWrite(&_impl_);
  ::uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
::uint8_t* PROTOBUF_NONNULL Value::_InternalSerialize(
...
#endif  // PROTOBUF_CUSTOM_VTABLE
  // @@protoc_insertion_point(serialize_to_array_start:shared.v1.Value)
  ::uint32_t cached_has_bits = 0;
  (void)cached_has_bits;
  ...
  switch (this_.kind_case()) {
    ...
    case kStringValue: {
      ...
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "shared.v1.Value.string_value");
  ...
  // @@protoc_insertion_point(serialize_to_array_end:shared.v1.Value)
  return target;
}
...
::size_t Value::ByteSizeLong() const {
  const Value& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
  // @@protoc_insertion_point(message_byte_size_start:shared.v1.Value)
  ::size_t total_size = 0;
...
void Value::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:shared.v1.Value)
  ABSL_DCHECK_NE(&from, _this);
  ::uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_copy_from_start:shared.v1.Value)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:shared.v1.ListValue)
}
PROTOBUF_NDEBUG_INLINE ListValue::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility,
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const Impl_& from,
    const ::shared::v1::ListValue& from_msg)
...
ListValue::ListValue(
  ...
  // @@protoc_insertion_point(copy_constructor:shared.v1.ListValue)
}
PROTOBUF_NDEBUG_INLINE ListValue::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility,
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena)
...
ListValue::~ListValue() {
  // @@protoc_insertion_point(destructor:shared.v1.ListValue)
  SharedDtor(*this);
}
...
ListValue::_table_ = {
  {
    ...
    ::_pbi::TcParser::GenericFallback,  // fallback
    #ifdef PROTOBUF_PREFETCH_PARSE_TABLE
    ::_pbi::TcParser::GetTable<::shared::v1::ListValue>(),  // to_prefetch
    #endif  // PROTOBUF_PREFETCH_PARSE_TABLE
  }, {{
...
// @@protoc_insertion_point(message_clear_start:shared.v1.ListValue)
  ::google::protobuf::internal::TSanWrite(&_impl_);
  ::uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
::uint8_t* PROTOBUF_NONNULL ListValue::_InternalSerialize(
...
#endif  // PROTOBUF_CUSTOM_VTABLE
  // @@protoc_insertion_point(serialize_to_array_start:shared.v1.ListValue)
  ::uint32_t cached_has_bits = 0;
  (void)cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:shared.v1.ListValue)
  return target;
}
...
::size_t ListValue::ByteSizeLong() const {
  const ListValue& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
  // @@protoc_insertion_point(message_byte_size_start:shared.v1.ListValue)
  ::size_t total_size = 0;
...
void ListValue::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:shared.v1.ListValue)
  ABSL_DCHECK_NE(&from, _this);
  ::uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_copy_from_start:shared.v1.ListValue)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::std::false_type
    _static_init2_ [[maybe_unused]] =
        (::_pbi::AddDescriptors(&descriptor_table_shared_2fv1_2fstruct_2eproto),
         ::std::false_type{});
