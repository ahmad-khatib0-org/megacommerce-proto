...
enum Extension : int;
extern const uint32_t Extension_internal_data_[];
enum Format : int;
...
class KafkaHookOptions_ExtraKafkaOptsEntry_DoNotUse;
struct KafkaHookOptions_ExtraKafkaOptsEntry_DoNotUseDefaultTypeInternal;
extern KafkaHookOptions_ExtraKafkaOptsEntry_DoNotUseDefaultTypeInternal _KafkaHookOptions_ExtraKafkaOptsEntry_DoNotUse_default_instance_;
extern const ::google::protobuf::internal::ClassDataFull KafkaHookOptions_ExtraKafkaOptsEntry_DoNotUse_class_data_;
...
template <>
internal::EnumTraitsT<::uploader::v1::Extension_internal_data_>
    internal::EnumTraitsImpl::value<::uploader::v1::Extension>;
template <>
...
inline constexpr AvailableDataStorages AvailableDataStorages_MAX =
    static_cast<AvailableDataStorages>(3);
inline bool AvailableDataStorages_IsValid(int value) {
  return 0 <= value && value <= 3;
}
inline constexpr int AvailableDataStorages_ARRAYSIZE = 3 + 1;
...
inline const ::std::string& AvailableDataStorages_Name(AvailableDataStorages value) {
  return ::google::protobuf::internal::NameOfDenseEnum<AvailableDataStorages_descriptor, 0, 3>(
...
inline constexpr AvailableInfoStorages AvailableInfoStorages_MAX =
    static_cast<AvailableInfoStorages>(3);
inline bool AvailableInfoStorages_IsValid(int value) {
  return 0 <= value && value <= 3;
}
inline constexpr int AvailableInfoStorages_ARRAYSIZE = 3 + 1;
...
inline const ::std::string& AvailableInfoStorages_Name(AvailableInfoStorages value) {
  return ::google::protobuf::internal::NameOfDenseEnum<AvailableInfoStorages_descriptor, 0, 3>(
      static_cast<int>(value));
}
...
inline constexpr int Hook_ARRAYSIZE = 6 + 1;
...
inline const ::std::string& Hook_Name(Hook value) {
  return ::google::protobuf::internal::NameOfDenseEnum<Hook_descriptor, 0, 6>(
      static_cast<int>(value));
}
...
enum Extension : int {
  ...
  CONCATENATION = 6,
  CHECKSUM = 7,
  Extension_INT_MIN_SENTINEL_DO_NOT_USE_ =
      ::std::numeric_limits<::int32_t>::min(),
  Extension_INT_MAX_SENTINEL_DO_NOT_USE_ =
      ::std::numeric_limits<::int32_t>::max(),
};

extern const uint32_t Extension_internal_data_[];
inline constexpr Extension Extension_MIN =
    static_cast<Extension>(0);
inline constexpr Extension Extension_MAX =
    static_cast<Extension>(7);
inline bool Extension_IsValid(int value) {
  return 0 <= value && value <= 7;
}
inline constexpr int Extension_ARRAYSIZE = 7 + 1;
const ::google::protobuf::EnumDescriptor* PROTOBUF_NONNULL Extension_descriptor();
template <typename T>
const ::std::string& Extension_Name(T value) {
  static_assert(::std::is_same<T, Extension>::value ||
                    ::std::is_integral<T>::value,
                "Incorrect type passed to Extension_Name().");
  return Extension_Name(static_cast<Extension>(value));
}
template <>
inline const ::std::string& Extension_Name(Extension value) {
  return ::google::protobuf::internal::NameOfDenseEnum<Extension_descriptor, 0, 7>(
      static_cast<int>(value));
}
inline bool Extension_Parse(
    ::absl::string_view name, Extension* PROTOBUF_NONNULL value) {
  return ::google::protobuf::internal::ParseNamedEnum<Extension>(Extension_descriptor(), name,
                                           value);
}
...
/* @@protoc_insertion_point(class_definition:uploader.v1.NatsHookOptions) */ {
 public:
  ...
  enum SubjectOrPrefixCase {
    kSubject = 2,
    kPrefix = 3,
    SUBJECT_OR_PREFIX_NOT_SET = 0,
  };
 ...
 public:
  ...
  public:
  void clear_subject_or_prefix();
  SubjectOrPrefixCase subject_or_prefix_case() const;
  // @@protoc_insertion_point(class_scope:uploader.v1.NatsHookOptions)
 private:
  class _Internal;
  void set_has_subject();
  void set_has_prefix();
  inline bool has_subject_or_prefix() const;
  inline void clear_has_subject_or_prefix();
  friend class ::google::protobuf::internal::TcParser;
  ...
  struct Impl_ {
    ...
    union SubjectOrPrefixUnion {
      constexpr SubjectOrPrefixUnion() : _constinit_{} {}
...
class KafkaHookOptions_ExtraKafkaOptsEntry_DoNotUse final
 ...
 public:
  using SuperType =
      ::google::protobuf::internal::MapEntry<std::string, std::string,
                      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
                      ::google::protobuf::internal::WireFormatLite::TYPE_STRING>;
  KafkaHookOptions_ExtraKafkaOptsEntry_DoNotUse();
  template <typename = void>
  explicit PROTOBUF_CONSTEXPR KafkaHookOptions_ExtraKafkaOptsEntry_DoNotUse(::google::protobuf::internal::ConstantInitialized);
  explicit KafkaHookOptions_ExtraKafkaOptsEntry_DoNotUse(::google::protobuf::Arena* PROTOBUF_NULLABLE arena);
  static constexpr const void* PROTOBUF_NONNULL internal_default_instance() {
    return &_KafkaHookOptions_ExtraKafkaOptsEntry_DoNotUse_default_instance_;
  }
...
/* @@protoc_insertion_point(class_definition:uploader.v1.InfoStoreOptions) */ {
 ...
 public:
  ...
  ::uint64_t redis_info_expiration() const;
  void set_redis_info_expiration(::uint64_t value);

  private:
  ::uint64_t _internal_redis_info_expiration() const;
  void _internal_set_redis_info_expiration(::uint64_t value);
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::uint64_t redis_info_expiration_;
    int info_storage_;
    PROTOBUF_TSAN_DECLARE_MEMBER
  };
  union { Impl_ _impl_; };
...
/* @@protoc_insertion_point(class_definition:uploader.v1.DataStorageOptions) */ {
 ...
 public:
  ...
  enum : int {
    ...
    kS3BucketFieldNumber = 10,
    kS3RegionFieldNumber = 11,
    kS3AccessKeyFieldNumber = 12,
    kS3AccessKeyPathFieldNumber = 13,
    kS3SecretKeyFieldNumber = 14,
    kS3SecretKeyPathFieldNumber = 15,
    kS3UrlFieldNumber = 16,
    kS3SecurityTokenFieldNumber = 18,
    kS3SessionTokenFieldNumber = 19,
    kS3ProfileFieldNumber = 20,
    kS3HeadersFieldNumber = 21,
    kStorageFieldNumber = 1,
    kForceFsyncFieldNumber = 4,
    kS3ForcePathStyleFieldNumber = 17,
    kS3ConcatConcurrentDownloadsFieldNumber = 22,
  };
...
/* @@protoc_insertion_point(class_definition:uploader.v1.AMQPHooksOptions) */ {
 ...
 public:
  ...
  enum : int {
    kUrlFieldNumber = 1,
    kExchangeFieldNumber = 10,
    kExchangeKindFieldNumber = 11,
    kRoutingKeyFieldNumber = 12,
    kQueuesPrefixFieldNumber = 13,
    ...
    kAutoDeleteFieldNumber = 18,
    kConnectionPoolSizeFieldNumber = 14,
    kChannelPoolSizeFieldNumber = 15,
    kIdleConnectionTimeoutFieldNumber = 16,
    kIdleChannelsTimeoutFieldNumber = 17,
  };
...
/* @@protoc_insertion_point(class_definition:uploader.v1.KafkaHookOptions) */ {
 public:
  ...
  enum TopicOrPrefixCase {
    kTopic = 3,
    kPrefix = 4,
    TOPIC_OR_PREFIX_NOT_SET = 0,
  };
 ...
 public:
  ...
  int extra_kafka_opts_size() const;
  private:
  int _internal_extra_kafka_opts_size() const;

  public:
  void clear_extra_kafka_opts() ;
  const ::google::protobuf::Map<std::string, std::string>& extra_kafka_opts() const;
  ::google::protobuf::Map<std::string, std::string>* PROTOBUF_NONNULL mutable_extra_kafka_opts();

  private:
  const ::google::protobuf::Map<std::string, std::string>& _internal_extra_kafka_opts() const;
  ::google::protobuf::Map<std::string, std::string>* PROTOBUF_NONNULL _internal_mutable_extra_kafka_opts();
  ...
  public:
  void clear_topic_or_prefix();
  TopicOrPrefixCase topic_or_prefix_case() const;
  // @@protoc_insertion_point(class_scope:uploader.v1.KafkaHookOptions)
 private:
  class _Internal;
  void set_has_topic();
  void set_has_prefix();
  inline bool has_topic_or_prefix() const;
  inline void clear_has_topic_or_prefix();
  friend class ::google::protobuf::internal::TcParser;
  ...
  struct Impl_ {
    ...
    ::google::protobuf::internal::HasBits<1> _has_bits_;
    ::google::protobuf::internal::CachedSize _cached_size_;
    ::google::protobuf::internal::MapField<KafkaHookOptions_ExtraKafkaOptsEntry_DoNotUse, std::string, std::string,
                      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
                      ::google::protobuf::internal::WireFormatLite::TYPE_STRING>
        extra_kafka_opts_;
    ...
    union TopicOrPrefixUnion {
      constexpr TopicOrPrefixUnion() : _constinit_{} {}
      ::google::protobuf::internal::ConstantInitialized _constinit_;
...
/* @@protoc_insertion_point(class_definition:uploader.v1.NotificationsOptions) */ {
 ...
 public:
  ...
  enum : int {
    ...
    kHooksDirFieldNumber = 10,
    kHooksFileFieldNumber = 11,
    kAmqpHookOptsFieldNumber = 20,
    kKafkaHookOptsFieldNumber = 21,
    kNatsHookOptsFieldNumber = 22,
...
/* @@protoc_insertion_point(class_definition:uploader.v1.RustusConf) */ {
 ...
 public:
  ...
  enum : int {
    kCorsFieldNumber = 10,
    kTusExtensionsFieldNumber = 14,
    kHostFieldNumber = 1,
    kUrlFieldNumber = 4,
    kLogLevelFieldNumber = 12,
    kStorageOptsFieldNumber = 20,
    kInfoStorageOptsFieldNumber = 21,
    kNotificationOptsFieldNumber = 22,
    kSentryOptsFieldNumber = 23,
    kPortFieldNumber = 2,
    kDisableHealthAccessLogFieldNumber = 3,
    kAllowEmptyFieldNumber = 15,
    kRemovePartsFieldNumber = 16,
    kMaxBodySizeFieldNumber = 11,
    kWorkersFieldNumber = 13,
    kMaxFileSizeFieldNumber = 17,
  };
  ...
  public:
  ::uploader::v1::Extension tus_extensions(int index) const;
  void set_tus_extensions(int index, ::uploader::v1::Extension value);
  void add_tus_extensions(::uploader::v1::Extension value);
  ...
  void set_max_body_size(::uint64_t value);

  private:
  ::uint64_t _internal_max_body_size() const;
  void _internal_set_max_body_size(::uint64_t value);

  public:
  // optional uint64 workers = 13 [json_name = "workers"];
  bool has_workers() const;
  void clear_workers() ;
  ::uint64_t workers() const;
  void set_workers(::uint64_t value);

  private:
  ::uint64_t _internal_workers() const;
  void _internal_set_workers(::uint64_t value);
  ...
  private:
  ::uint64_t _internal_max_file_size() const;
  void _internal_set_max_file_size(::uint64_t value);
...
inline void InfoStoreOptions::clear_redis_info_expiration() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.redis_info_expiration_ = ::uint64_t{0u};
  _impl_._has_bits_[0] &= ~0x00000004u;
}
inline ::uint64_t InfoStoreOptions::redis_info_expiration() const {
...
inline void InfoStoreOptions::set_redis_info_expiration(::uint64_t value) {
...
inline ::uint64_t InfoStoreOptions::_internal_redis_info_expiration() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.redis_info_expiration_;
}
inline void InfoStoreOptions::_internal_set_redis_info_expiration(::uint64_t value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
inline bool KafkaHookOptions::has_topic() const {
  return topic_or_prefix_case() == kTopic;
}
inline void KafkaHookOptions::set_has_topic() {
  _impl_._oneof_case_[0] = kTopic;
}
inline void KafkaHookOptions::clear_topic() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (topic_or_prefix_case() == kTopic) {
    _impl_.topic_or_prefix_.topic_.Destroy();
    clear_has_topic_or_prefix();
  }
}
...
PROTOBUF_ALWAYS_INLINE void KafkaHookOptions::set_topic(Arg_&& arg, Args_... args) {
  ...
  if (topic_or_prefix_case() != kTopic) {
    ...
    set_has_topic();
    _impl_.topic_or_prefix_.topic_.InitDefault();
  }
  _impl_.topic_or_prefix_.topic_.Set(static_cast<Arg_&&>(arg), args..., GetArena());
...
inline const ::std::string& KafkaHookOptions::_internal_topic() const {
  ...
  return _impl_.topic_or_prefix_.topic_.Get();
}
inline void KafkaHookOptions::_internal_set_topic(const ::std::string& value) {
  ...
  _impl_.topic_or_prefix_.topic_.Set(value, GetArena());
}
inline ::std::string* PROTOBUF_NONNULL KafkaHookOptions::_internal_mutable_topic() {
  ...
  return _impl_.topic_or_prefix_.topic_.Mutable( GetArena());
}
inline ::std::string* PROTOBUF_NULLABLE KafkaHookOptions::release_topic() {
  ...
  clear_has_topic_or_prefix();
  return _impl_.topic_or_prefix_.topic_.Release();
}
inline void KafkaHookOptions::set_allocated_topic(::std::string* PROTOBUF_NULLABLE value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (has_topic_or_prefix()) {
    clear_topic_or_prefix();
  }
  if (value != nullptr) {
    set_has_topic();
    _impl_.topic_or_prefix_.topic_.InitAllocated(value, GetArena());
  }
...
inline bool KafkaHookOptions::has_prefix() const {
  return topic_or_prefix_case() == kPrefix;
}
inline void KafkaHookOptions::set_has_prefix() {
  _impl_._oneof_case_[0] = kPrefix;
}
inline void KafkaHookOptions::clear_prefix() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (topic_or_prefix_case() == kPrefix) {
...
PROTOBUF_ALWAYS_INLINE void KafkaHookOptions::set_prefix(Arg_&& arg, Args_... args) {
  ...
  if (topic_or_prefix_case() != kPrefix) {
    ...
    set_has_prefix();
    _impl_.topic_or_prefix_.prefix_.InitDefault();
  }
  _impl_.topic_or_prefix_.prefix_.Set(static_cast<Arg_&&>(arg), args..., GetArena());
...
inline const ::std::string& KafkaHookOptions::_internal_prefix() const {
  ...
  return _impl_.topic_or_prefix_.prefix_.Get();
}
inline void KafkaHookOptions::_internal_set_prefix(const ::std::string& value) {
  ...
  _impl_.topic_or_prefix_.prefix_.Set(value, GetArena());
}
inline ::std::string* PROTOBUF_NONNULL KafkaHookOptions::_internal_mutable_prefix() {
  ...
  return _impl_.topic_or_prefix_.prefix_.Mutable( GetArena());
}
inline ::std::string* PROTOBUF_NULLABLE KafkaHookOptions::release_prefix() {
  ...
  clear_has_topic_or_prefix();
  return _impl_.topic_or_prefix_.prefix_.Release();
}
inline void KafkaHookOptions::set_allocated_prefix(::std::string* PROTOBUF_NULLABLE value) {
  ...
  if (value != nullptr) {
    set_has_prefix();
    _impl_.topic_or_prefix_.prefix_.InitAllocated(value, GetArena());
  }
...
// map<string, string> extra_kafka_opts = 20 [json_name = "extraKafkaOpts"];
inline int KafkaHookOptions::_internal_extra_kafka_opts_size() const {
  return _internal_extra_kafka_opts().size();
}
inline int KafkaHookOptions::extra_kafka_opts_size() const {
  return _internal_extra_kafka_opts_size();
}
inline void KafkaHookOptions::clear_extra_kafka_opts() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.extra_kafka_opts_.Clear();
}
inline const ::google::protobuf::Map<std::string, std::string>& KafkaHookOptions::_internal_extra_kafka_opts() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.extra_kafka_opts_.GetMap();
}
inline const ::google::protobuf::Map<std::string, std::string>& KafkaHookOptions::extra_kafka_opts() const ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_map:uploader.v1.KafkaHookOptions.extra_kafka_opts)
  return _internal_extra_kafka_opts();
}
inline ::google::protobuf::Map<std::string, std::string>* PROTOBUF_NONNULL KafkaHookOptions::_internal_mutable_extra_kafka_opts() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  return _impl_.extra_kafka_opts_.MutableMap();
}
inline ::google::protobuf::Map<std::string, std::string>* PROTOBUF_NONNULL KafkaHookOptions::mutable_extra_kafka_opts()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_mutable_map:uploader.v1.KafkaHookOptions.extra_kafka_opts)
  return _internal_mutable_extra_kafka_opts();
}

inline bool KafkaHookOptions::has_topic_or_prefix() const {
  return topic_or_prefix_case() != TOPIC_OR_PREFIX_NOT_SET;
}
inline void KafkaHookOptions::clear_has_topic_or_prefix() {
  _impl_._oneof_case_[0] = TOPIC_OR_PREFIX_NOT_SET;
}
inline KafkaHookOptions::TopicOrPrefixCase KafkaHookOptions::topic_or_prefix_case() const {
  return KafkaHookOptions::TopicOrPrefixCase(_impl_._oneof_case_[0]);
}
// -------------------------------------------------------------------
...
inline bool NatsHookOptions::has_subject() const {
  return subject_or_prefix_case() == kSubject;
}
inline void NatsHookOptions::set_has_subject() {
  _impl_._oneof_case_[0] = kSubject;
}
inline void NatsHookOptions::clear_subject() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (subject_or_prefix_case() == kSubject) {
    _impl_.subject_or_prefix_.subject_.Destroy();
    clear_has_subject_or_prefix();
  }
}
...
PROTOBUF_ALWAYS_INLINE void NatsHookOptions::set_subject(Arg_&& arg, Args_... args) {
  ...
  if (subject_or_prefix_case() != kSubject) {
    ...
    set_has_subject();
    _impl_.subject_or_prefix_.subject_.InitDefault();
  }
  _impl_.subject_or_prefix_.subject_.Set(static_cast<Arg_&&>(arg), args..., GetArena());
...
inline const ::std::string& NatsHookOptions::_internal_subject() const {
  ...
  return _impl_.subject_or_prefix_.subject_.Get();
}
inline void NatsHookOptions::_internal_set_subject(const ::std::string& value) {
  ...
  _impl_.subject_or_prefix_.subject_.Set(value, GetArena());
}
inline ::std::string* PROTOBUF_NONNULL NatsHookOptions::_internal_mutable_subject() {
  ...
  return _impl_.subject_or_prefix_.subject_.Mutable( GetArena());
}
inline ::std::string* PROTOBUF_NULLABLE NatsHookOptions::release_subject() {
  ...
  clear_has_subject_or_prefix();
  return _impl_.subject_or_prefix_.subject_.Release();
}
inline void NatsHookOptions::set_allocated_subject(::std::string* PROTOBUF_NULLABLE value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (has_subject_or_prefix()) {
    clear_subject_or_prefix();
  }
  if (value != nullptr) {
    set_has_subject();
    _impl_.subject_or_prefix_.subject_.InitAllocated(value, GetArena());
  }
...
inline bool NatsHookOptions::has_prefix() const {
  return subject_or_prefix_case() == kPrefix;
}
inline void NatsHookOptions::set_has_prefix() {
  _impl_._oneof_case_[0] = kPrefix;
}
inline void NatsHookOptions::clear_prefix() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (subject_or_prefix_case() == kPrefix) {
...
PROTOBUF_ALWAYS_INLINE void NatsHookOptions::set_prefix(Arg_&& arg, Args_... args) {
  ...
  if (subject_or_prefix_case() != kPrefix) {
    ...
    set_has_prefix();
    _impl_.subject_or_prefix_.prefix_.InitDefault();
  }
  _impl_.subject_or_prefix_.prefix_.Set(static_cast<Arg_&&>(arg), args..., GetArena());
...
inline const ::std::string& NatsHookOptions::_internal_prefix() const {
  ...
  return _impl_.subject_or_prefix_.prefix_.Get();
}
inline void NatsHookOptions::_internal_set_prefix(const ::std::string& value) {
  ...
  _impl_.subject_or_prefix_.prefix_.Set(value, GetArena());
}
inline ::std::string* PROTOBUF_NONNULL NatsHookOptions::_internal_mutable_prefix() {
  ...
  return _impl_.subject_or_prefix_.prefix_.Mutable( GetArena());
}
inline ::std::string* PROTOBUF_NULLABLE NatsHookOptions::release_prefix() {
  ...
  clear_has_subject_or_prefix();
  return _impl_.subject_or_prefix_.prefix_.Release();
}
inline void NatsHookOptions::set_allocated_prefix(::std::string* PROTOBUF_NULLABLE value) {
  ...
  if (value != nullptr) {
    set_has_prefix();
    _impl_.subject_or_prefix_.prefix_.InitAllocated(value, GetArena());
  }
...
inline bool NatsHookOptions::has_subject_or_prefix() const {
  return subject_or_prefix_case() != SUBJECT_OR_PREFIX_NOT_SET;
}
inline void NatsHookOptions::clear_has_subject_or_prefix() {
  _impl_._oneof_case_[0] = SUBJECT_OR_PREFIX_NOT_SET;
}
inline NatsHookOptions::SubjectOrPrefixCase NatsHookOptions::subject_or_prefix_case() const {
  return NatsHookOptions::SubjectOrPrefixCase(_impl_._oneof_case_[0]);
}
// -------------------------------------------------------------------
...
inline void RustusConf::clear_max_body_size() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.max_body_size_ = ::uint64_t{0u};
  _impl_._has_bits_[0] &= ~0x00000800u;
}
inline ::uint64_t RustusConf::max_body_size() const {
  // @@protoc_insertion_point(field_get:uploader.v1.RustusConf.max_body_size)
  return _internal_max_body_size();
}
inline void RustusConf::set_max_body_size(::uint64_t value) {
  _internal_set_max_body_size(value);
  _impl_._has_bits_[0] |= 0x00000800u;
  // @@protoc_insertion_point(field_set:uploader.v1.RustusConf.max_body_size)
}
inline ::uint64_t RustusConf::_internal_max_body_size() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.max_body_size_;
}
inline void RustusConf::_internal_set_max_body_size(::uint64_t value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
inline void RustusConf::clear_workers() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.workers_ = ::uint64_t{0u};
  _impl_._has_bits_[0] &= ~0x00001000u;
}
inline ::uint64_t RustusConf::workers() const {
  // @@protoc_insertion_point(field_get:uploader.v1.RustusConf.workers)
  return _internal_workers();
}
inline void RustusConf::set_workers(::uint64_t value) {
  _internal_set_workers(value);
  _impl_._has_bits_[0] |= 0x00001000u;
  // @@protoc_insertion_point(field_set:uploader.v1.RustusConf.workers)
}
inline ::uint64_t RustusConf::_internal_workers() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.workers_;
}
inline void RustusConf::_internal_set_workers(::uint64_t value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
inline ::uploader::v1::Extension RustusConf::tus_extensions(int index) const {
  // @@protoc_insertion_point(field_get:uploader.v1.RustusConf.tus_extensions)
  return static_cast<::uploader::v1::Extension>(_internal_tus_extensions().Get(index));
}
inline void RustusConf::set_tus_extensions(int index, ::uploader::v1::Extension value) {
  _internal_mutable_tus_extensions()->Set(index, value);
  // @@protoc_insertion_point(field_set:uploader.v1.RustusConf.tus_extensions)
}
inline void RustusConf::add_tus_extensions(::uploader::v1::Extension value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
inline void RustusConf::clear_max_file_size() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.max_file_size_ = ::uint64_t{0u};
  _impl_._has_bits_[0] &= ~0x00002000u;
}
inline ::uint64_t RustusConf::max_file_size() const {
  // @@protoc_insertion_point(field_get:uploader.v1.RustusConf.max_file_size)
  return _internal_max_file_size();
}
inline void RustusConf::set_max_file_size(::uint64_t value) {
  _internal_set_max_file_size(value);
  _impl_._has_bits_[0] |= 0x00002000u;
  // @@protoc_insertion_point(field_set:uploader.v1.RustusConf.max_file_size)
}
inline ::uint64_t RustusConf::_internal_max_file_size() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.max_file_size_;
}
inline void RustusConf::_internal_set_max_file_size(::uint64_t value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
template <>
struct is_proto_enum<::uploader::v1::Extension> : std::true_type {};
template <>
inline const EnumDescriptor* PROTOBUF_NONNULL GetEnumDescriptor<::uploader::v1::Extension>() {
  return ::uploader::v1::Extension_descriptor();
}
