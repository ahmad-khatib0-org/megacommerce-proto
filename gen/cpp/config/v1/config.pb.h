...
PROTOBUF_NAMESPACE_OPEN
template<> ::config::v1::GetConfigRequest* Arena::CreateMaybeMessage<::config::v1::GetConfigRequest>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace config {
namespace v1 {
...
class GetConfigRequest final :
    public ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase /* @@protoc_insertion_point(class_definition:config.v1.GetConfigRequest) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "config.v1.GetConfigRequest";
  }
  protected:
