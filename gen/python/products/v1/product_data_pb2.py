...
DESCRIPTOR = _descriptor_pool.Default().AddSerializedFile(b'\n\x1eproducts/v1/product_data.proto\x12\x0bproducts.v1\x1a\x19products/v1/product.proto\x1a$products/v1/product_categories.proto\x1a\x15shared/v1/error.proto\"\x8a\x01\n\x17ProductDataResponseData\x12,\n\x08\x63\x61tegory\x18\x01 \x01(\x0b\x32\x15.products.v1.CategoryH\x00\x88\x01\x01\x12+\n\x04tags\x18\x02 \x01(\x0b\x32\x18.products.v1.ProductTagsH\x01\x88\x01\x01\x42\x0b\n\t_categoryB\x07\n\x05_tags\"f\n\x12ProductDataRequest\x12\x1a\n\rcategory_name\x18\x01 \x01(\tH\x00\x88\x01\x01\x12\x15\n\x08get_tags\x18\x02 \x01(\x08H\x01\x88\x01\x01\x42\x10\n\x0e_category_nameB\x0b\n\t_get_tags\"}\n\x13ProductDataResponse\x12\x34\n\x04\x64\x61ta\x18\x01 \x01(\x0b\x32$.products.v1.ProductDataResponseDataH\x00\x12$\n\x05\x65rror\x18\x02 \x01(\x0b\x32\x13.shared.v1.AppErrorH\x00\x42\n\n\x08responseBz\n\x1corg.megacommerce.products.v1B\x10ProductDataProtoZEgithub.com/ahmad-khatib0-org/megacommerce-proto/gen/go/products/v1;v1\xf8\x01\x01\x62\x06proto3')
...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_PRODUCTDATARESPONSEDATA']._serialized_end=274
  _globals['_PRODUCTDATAREQUEST']._serialized_start=276
  _globals['_PRODUCTDATAREQUEST']._serialized_end=378
  _globals['_PRODUCTDATARESPONSE']._serialized_start=380
  _globals['_PRODUCTDATARESPONSE']._serialized_end=505
