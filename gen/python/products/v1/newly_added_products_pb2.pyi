...
class NewlyAddedProductListItem(_message.Message):
    __slots__ = ("id", "title", "image", "price_cents", "created_at")
    ...
    price_cents: int
    created_at: str
    def __init__(self, id: _Optional[str] = ..., title: _Optional[str] = ..., image: _Optional[str] = ..., price_cents: _Optional[int] = ..., created_at: _Optional[str] = ...) -> None: ...
