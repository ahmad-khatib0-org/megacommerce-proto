...
class CustomerCreateRequest(_message.Message):
    __slots__ = ("username", "email", "first_name", "last_name", "password", "image")
    ...
    def __init__(self, username: _Optional[str] = ..., email: _Optional[str] = ..., first_name: _Optional[str] = ..., last_name: _Optional[str] = ..., password: _Optional[str] = ..., image: _Optional[_Union[_attachment_pb2.Attachment, _Mapping]] = ...) -> None: ...

class CustomerCreateResponse(_message.Message):
