...
goog.exportSymbol('proto.common.v1.TranslationsGetResponse.ResponseCase', null, global);
/**
...
proto.common.v1.TranslationsGetResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, proto.common.v1.TranslationsGetResponse.oneofGroups_);
};
 ...
 * @return {string}
 */
proto.common.v1.TranslationsGetRequest.prototype.getLang = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.common.v1.TranslationsGetRequest} returns this
 */
proto.common.v1.TranslationsGetRequest.prototype.setLang = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @const
 */
proto.common.v1.TranslationsGetResponse.oneofGroups_ = [[1,2]];

/**
 * @enum {number}
 */
proto.common.v1.TranslationsGetResponse.ResponseCase = {
  RESPONSE_NOT_SET: 0,
  DATA: 1,
  ERROR: 2
};
...
/**
 * @return {proto.common.v1.TranslationsGetResponse.ResponseCase}
 */
proto.common.v1.TranslationsGetResponse.prototype.getResponseCase = function() {
  return /** @type {proto.common.v1.TranslationsGetResponse.ResponseCase} */(jspb.Message.computeOneofCase(this, proto.common.v1.TranslationsGetResponse.oneofGroups_[0]));
};
...
proto.common.v1.TranslationsGetResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    data: (f = msg.getData()) && common_v1_types_pb.TranslationElements.toObject(includeInstance, f),
    error: (f = msg.getError()) && common_v1_error_pb.AppError.toObject(includeInstance, f)
  };
...
proto.common.v1.TranslationsGetResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new common_v1_types_pb.TranslationElements;
      reader.readMessage(value,common_v1_types_pb.TranslationElements.deserializeBinaryFromReader);
      msg.setData(value);
      break;
    case 2:
      var value = new common_v1_error_pb.AppError;
...
proto.common.v1.TranslationsGetResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      common_v1_types_pb.TranslationElements.serializeBinaryToWriter
    );
  }
  f = message.getError();
  if (f != null) {
 ...
 */
proto.common.v1.TranslationsGetResponse.prototype.getData = function() {
  return /** @type{?proto.common.v1.TranslationElements} */ (
    jspb.Message.getWrapperField(this, common_v1_types_pb.TranslationElements, 1));
};
...
*/
proto.common.v1.TranslationsGetResponse.prototype.setData = function(value) {
  return jspb.Message.setOneofWrapperField(this, 1, proto.common.v1.TranslationsGetResponse.oneofGroups_[0], value);
};
 ...
 * @return {!proto.common.v1.TranslationsGetResponse} returns this
 */
proto.common.v1.TranslationsGetResponse.prototype.clearData = function() {
  return this.setData(undefined);
};
 ...
 * @return {boolean}
 */
proto.common.v1.TranslationsGetResponse.prototype.hasData = function() {
  return jspb.Message.getField(this, 1) != null;
};
...
proto.common.v1.TranslationsGetResponse.prototype.setError = function(value) {
  return jspb.Message.setOneofWrapperField(this, 2, proto.common.v1.TranslationsGetResponse.oneofGroups_[0], value);
};
